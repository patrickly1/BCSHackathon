...
//               robotX,
//               robotY - height * 0.3,
//               "You’re at base with everything you collected from the mine.\n\nIt’s time to bring that work into the project. Run git merge mine to combine your progress.\n\nThen walk over to the spaceship—it’s ready for repairs.\n\nPush your updates to mission control using git push, and prepare for launch.",
//               {
//                   fontSize: "10px",
//                   fill: "#00ffcc",
//                   stroke: "#003344",
  ...
  handleCommand(command) {
    ...
    if (action === 'git') {
      ...
      if (verb === 'reset') {
        ...
        if (!this.resetDone) {
          this.resetDone = true;
          // Show the spaceship image at a designated location
          this.add.image(width * 0.5, height * 0.2, "spaceship");
          this.setFeedback("Reset successful! Finalize your mission with: git push");
      ...
      if (verb === 'push') {
        ...
        this.setFeedback("Mission accomplished! Your changes have been pushed. Game Over.");
        this.time.delayedCall(2000, () => {
          this.scene.start('EndScene'); // Replace with your final scene key.
        });
        return;
      }
    }
